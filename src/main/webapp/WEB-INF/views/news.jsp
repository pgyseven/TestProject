...
<body>
    ...
    <section class="categories">
        <div class="container">
            <div class="row">
                ...
                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1440px, 0px, 0px); transition: 1.2s; width: 3120px;"><div class="owl-item cloned" style="width: 240px;"><div class="col-lg-3">
                    ...
                    </div></div><div class="owl-item active" style="width: 240px;"><div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/cat-3.jpg" style="background-image: url(&quot;img/categories/cat-3.jpg&quot;);">
                            <h5><a href="#">Vegetables</a></h5>
                        </div>
                    </div></div><div class="owl-item active" style="width: 240px;"><div class="col-lg-3">
                    ...
                    </div></div><div class="owl-item cloned active" style="width: 240px;"><div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/cat-1.jpg" style="background-image: url(&quot;img/categories/cat-1.jpg&quot;);">
                            <h5><a href="#">Fresh Fruit</a></h5>
                        </div>
                    </div></div><div class="owl-item cloned" style="width: 240px;"><div class="col-lg-3">
    ...
    <section class="featured spad">
        <div class="container">
            ...
            <div class="row featured__filter" id="MixItUpC78AB9">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="latest-product__text">
                        ...
                        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-580px, 0px, 0px); transition: 1.2s; width: 1740px;"><div class="owl-item cloned" style="width: 290px;"><div class="latest-prdouct__slider__item">
                            ...
                            </div></div><div class="owl-item cloned" style="width: 290px;"><div class="latest-prdouct__slider__item">
                                <a href="#" class="latest-product__item">
                                    <div class="latest-product__item__pic">
                                        <img src="img/latest-product/lp-1.jpg" alt="">
                                    </div>
                            ...
                            </div></div><div class="owl-item active" style="width: 290px;"><div class="latest-prdouct__slider__item">
                                <a href="#" class="latest-product__item">
                                    <div class="latest-product__item__pic">
                                        <img src="img/latest-product/lp-1.jpg" alt="">
                                    </div>
                            ...
                            </div></div><div class="owl-item" style="width: 290px;"><div class="latest-prdouct__slider__item">
                                <a href="#" class="latest-product__item">
                                    <div class="latest-product__item__pic">
                                        <img src="img/latest-product/lp-1.jpg" alt="">
                                    </div>
